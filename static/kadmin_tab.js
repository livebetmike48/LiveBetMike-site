...
(function () {
  ...
  window.renderKAdmin = async function renderKAdmin() {
    ...
    foot.textContent = "Caps take effect on the next board build (within ~15 min, or immediately on a fresh load). " +
      "A read already frozen today keeps its logged price — the cap changes what the board shows and, if you " +
      "exclude it, whether it counts.";
